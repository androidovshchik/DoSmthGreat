...
public class MonthView extends View {
    ...
    public void setHighlight(int i, HighlightStyle style) {
        mDayArray.append(i, style);
    }
    ...
    private void updateWeekdayArray() {
        Resources resources = getContext().getResources();
        mWeekdayName = resources.getStringArray(R.array.weekday_name);
    }
